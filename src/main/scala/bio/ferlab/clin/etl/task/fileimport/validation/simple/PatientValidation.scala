...
import bio.ferlab.clin.etl.task.fileimport.model.{InputPatient, SimplePatient}
...
object PatientValidation {
  ...
  def validatePatient(p: SimplePatient)(implicit clinClient: IClinFhirClient): ValidationResult[IdType] = {

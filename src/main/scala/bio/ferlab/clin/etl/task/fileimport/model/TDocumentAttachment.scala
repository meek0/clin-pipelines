...
object SV_VCF {
  implicit case object builder extends ToAttachment[SV_VCF] {
    ...
    override def analysisFileName: Analysis => String = a => a.files.sv_vcf.getOrElse("sv_vcf")
...
object SV_TBI {
  implicit case object builder extends ToAttachment[SV_TBI] {
    ...
    override def analysisFileName: Analysis => String = a => a.files.sv_tbi.getOrElse("sv_tbi")
...
object EXOMISER_HTML {
  implicit case object builder extends ToAttachment[EXOMISER_HTML] {
    ...
    override def analysisFileName: Analysis => String = a => a.files.exomiser_html.getOrElse("exomiser_html")
...
object EXOMISER_JSON {
  implicit case object builder extends ToAttachment[EXOMISER_JSON] {
    ...
    override def analysisFileName: Analysis => String = a => a.files.exomiser_json.getOrElse("exomiser_json")
...
object EXOMISER_VARIANTS_TSV {
  implicit case object builder extends ToAttachment[EXOMISER_VARIANTS_TSV] {
    ...
    override def analysisFileName: Analysis => String = a => a.files.exomiser_variants_tsv.getOrElse("exomiser_variants_tsv")
...
object SEG_BW {
  implicit case object builder extends ToAttachment[SEG_BW] {
    ...
    override def analysisFileName: Analysis => String = a => a.files.seg_bw.getOrElse("seg_bw")
...
object HARD_FILTERED_BAF_BW {
  implicit case object builder extends ToAttachment[HARD_FILTERED_BAF_BW] {
    ...
    override def analysisFileName: Analysis => String = a => a.files.hard_filtered_baf_bw.getOrElse("hard_filtered_baf_bw")
...
object ROH_BED {
  implicit case object builder extends ToAttachment[ROH_BED] {
    ...
    override def analysisFileName: Analysis => String = a => a.files.roh_bed.getOrElse("roh_bed")
...
object HYPER_EXOME_HG38_BED {
  implicit case object builder extends ToAttachment[HYPER_EXOME_HG38_BED] {
    ...
    override def analysisFileName: Analysis => String = a => a.files.hyper_exome_hg38_bed.getOrElse("hyper_exome_hg38_bed")
...
object CNV_CALLS_PNG {
  implicit case object builder extends ToAttachment[CNV_CALLS_PNG] {
    ...
    override def analysisFileName: Analysis => String = a => a.files.cnv_calls_png.getOrElse("cnv_calls_png")
...
object COVERAGE_BY_GENE_CSV {
  implicit case object builder extends ToAttachment[COVERAGE_BY_GENE_CSV] {
    ...
    override def analysisFileName: Analysis => String = a => a.files.coverage_by_gene_csv.getOrElse("coverage_by_gene_csv")
...
object QC_METRICS {
  implicit case object builder extends ToAttachment[QC_METRICS] {
    ...
    override def analysisFileName: Analysis => String = a => a.files.qc_metrics.getOrElse("qc_metrics")

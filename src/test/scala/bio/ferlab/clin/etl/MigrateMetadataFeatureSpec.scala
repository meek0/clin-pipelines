  ...
  "run" should "return no errors" in {
    withS3Objects { (inputPrefix, _) =>
      ...
      m.analyses.head shouldBe FullAnalysis("_LDM_ORGANIZATION_ID_",
        ...
        "NBL",Some("NBL"),"_LDM_SERVICE_REQUEST_ID_","nanuq_sample_id", None,
        FullPatient("John","Doe","male",Some("_RAMQ_"),"06/03/2001",Some("_MRN_"),"_EP_ORGANIZATION_ID_",Some("SOLO"),"PROB",None,"AFF",None),
        FilesAnalysis("file1.cram","file1.crai","file2.vcf","file2.tbi","file4.vcf","file4.tbi",Some("file5.vcf"),Some("file5.tbi"),"file3.json",Some("file6.html"),Some("file6.json"),Some("file6.variants.tsv"),Some("file7.seg.bw"),Some("file7.baf.bw"),Some("file7.roh.bed"),Some("file7.exome.bed"),Some("file8.png"),Some("file9.csv"),Some("file10.json")),
        Some("MMG"), None,

...
import bio.ferlab.clin.etl.testutils.MetadataTestUtils.{defaultAnalysis, defaultAnalysisWithOptionals, defaultMetadata, defaultMetadataWithOptionals, defaultPatient, extumMetadataWithOptionals}
